...
This behavior is similar to how the Mitsubishi MHK2 thermostat manages dual setpoints. The room temperature can drift naturally within the deadband zone without the heat pump intervening. The heat pump only activates when the temperature crosses the LOW or HIGH boundaries.
